        ...
        scf.for %arg9 = %c0 to %9 step %c1 {
          ...
          scf.for %arg10 = %c0 to %10 step %c1 {
            ...
            ^bb0(%out: f64):
              ...
              %24 = arith.muli %22, %c3_i32 : i32
              %25 = arith.addi %24, %15 : i32
              %26 = arith.index_cast %25 : i32 to index
              %27 = memref.load %arg0[%26] : memref<?xf64>
              %28 = arith.muli %22, %c4_i32 : i32
          ...
          affine.for %arg10 = 0 to 5 {
            ...
            %17 = arith.muli %15, %c4_i32 : i32
            %18 = arith.addi %17, %13 : i32
            %19 = arith.index_cast %18 : i32 to index
            %20 = memref.load %arg2[%19] : memref<?xf64>
            %21 = arith.negf %20 : f64
            %22 = arith.muli %15, %c3_i32 : i32
            %23 = arith.addi %22, %13 : i32
            %24 = arith.index_cast %23 : i32 to index
            %25 = memref.load %arg0[%24] : memref<?xf64>
            %26 = arith.select %16, %21, %25 : f64
            ...
            ^bb0(%in: f64, %out: f64):
              %27 = arith.mulf %in, %26 : f64
              %28 = arith.addf %out, %27 : f64
              linalg.yield %28 : f64
            }
          }
        }
        %11 = arith.muli %8, %6 : i32
        ...
        affine.for %arg9 = 0 to 2 {
          ...
          affine.for %arg10 = 0 to 5 {
            ...
            scf.for %arg11 = %c0 to %10 step %c1 {
              ...
              %21 = memref.load %arg1[%20] : memref<?xf64>
          ...
          scf.for %arg10 = %c0 to %11 step %c1 {
            ...
            %21 = arith.muli %14, %c5_i32 : i32
            %22 = arith.addi %21, %3 : i32
            %23 = arith.index_cast %22 : i32 to index
            %24 = memref.load %arg1[%23] : memref<?xf64>
            %25 = arith.select %15, %20, %24 : f64
            %26 = arith.muli %14, %9 : i32
            scf.for %arg11 = %c0 to %10 step %c1 {
              ...
              %32 = memref.load %alloca[%arg11] : memref<4xf64>
              %33 = arith.mulf %32, %25 : f64
              %34 = memref.load %arg6[%31] : memref<?xf64>
              %35 = arith.addf %34, %33 : f64
              memref.store %35, %arg6[%31] : memref<?xf64>
            }
          }
