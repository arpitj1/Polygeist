...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @mfem_app_mtop_iso_elasticity_dfem_2d(%arg0: memref<?xf64>, %arg1: memref<?xf64>, %arg2: memref<?xf64>, %arg3: memref<?xf64>, %arg4: memref<?xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>, %arg7: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %15 = linalg.generic {doc = "", indexing_maps = [#map3, #map3, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%14, %13 : tensor<?x?x?x?xf64>, tensor<?x?x?x?xf64>) outs(%inserted_slice : tensor<2x4x5xf64>) {
    ^bb0(%in: f64, %in_30: f64, %out: f64):
      %153 = arith.mulf %in, %in_30 : f64
    ...
    %19 = linalg.generic {doc = "", indexing_maps = [#map3, #map3, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%18, %17 : tensor<?x?x?x?xf64>, tensor<?x?x?x?xf64>) outs(%inserted_slice_1 : tensor<2x4x5xf64>) {
    ^bb0(%in: f64, %in_30: f64, %out: f64):
      %153 = arith.mulf %in, %in_30 : f64
      %154 = arith.addf %out, %153 : f64
      linalg.yield %154 : f64
    ...
    %25 = linalg.generic {doc = "", indexing_maps = [#map7, #map3, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice_2, %24 : tensor<?x?x?xf64>, tensor<?x?x?x?xf64>) outs(%23 : tensor<2x5x5xf64>) {
    ^bb0(%in: f64, %in_30: f64, %out: f64):
      %153 = arith.mulf %in, %in_30 : f64
      %154 = arith.addf %out, %153 : f64
      linalg.yield %154 : f64
    ...
    %32 = linalg.generic {doc = "", indexing_maps = [#map7, #map3, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice_3, %31 : tensor<?x?x?xf64>, tensor<?x?x?x?xf64>) outs(%30 : tensor<2x5x5xf64>) {
    ^bb0(%in: f64, %in_30: f64, %out: f64):
      %153 = arith.mulf %in, %in_30 : f64
      %154 = arith.addf %out, %153 : f64
      linalg.yield %154 : f64
    ...
    %39 = linalg.generic {doc = "", indexing_maps = [#map3, #map3, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%38, %37 : tensor<?x?x?x?xf64>, tensor<?x?x?x?xf64>) outs(%inserted_slice_5 : tensor<2x4x5xf64>) {
    ^bb0(%in: f64, %in_30: f64, %out: f64):
      %153 = arith.mulf %in, %in_30 : f64
      %154 = arith.addf %out, %153 : f64
      linalg.yield %154 : f64
    ...
    %43 = linalg.generic {doc = "", indexing_maps = [#map3, #map3, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%42, %41 : tensor<?x?x?x?xf64>, tensor<?x?x?x?xf64>) outs(%inserted_slice_7 : tensor<2x4x5xf64>) {
    ^bb0(%in: f64, %in_30: f64, %out: f64):
      %153 = arith.mulf %in, %in_30 : f64
      %154 = arith.addf %out, %153 : f64
      linalg.yield %154 : f64
    ...
    %49 = linalg.generic {doc = "", indexing_maps = [#map7, #map3, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice_8, %48 : tensor<?x?x?xf64>, tensor<?x?x?x?xf64>) outs(%47 : tensor<2x5x5xf64>) {
    ^bb0(%in: f64, %in_30: f64, %out: f64):
      %153 = arith.mulf %in, %in_30 : f64
      %154 = arith.addf %out, %153 : f64
      linalg.yield %154 : f64
    ...
    %56 = linalg.generic {doc = "", indexing_maps = [#map7, #map3, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice_9, %55 : tensor<?x?x?xf64>, tensor<?x?x?x?xf64>) outs(%54 : tensor<2x5x5xf64>) {
    ^bb0(%in: f64, %in_30: f64, %out: f64):
      %153 = arith.mulf %in, %in_30 : f64
      %154 = arith.addf %out, %153 : f64
      linalg.yield %154 : f64
    ...
    %117 = linalg.generic {doc = "", indexing_maps = [#map3, #map3, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%115, %116 : tensor<?x?x?x?xf64>, tensor<?x?x?x?xf64>) outs(%inserted_slice_15 : tensor<2x5x4xf64>) {
    ^bb0(%in: f64, %in_30: f64, %out: f64):
      %153 = arith.mulf %in, %in_30 : f64
      %154 = arith.addf %out, %153 : f64
      linalg.yield %154 : f64
    ...
    %121 = linalg.generic {doc = "", indexing_maps = [#map3, #map3, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%119, %120 : tensor<?x?x?x?xf64>, tensor<?x?x?x?xf64>) outs(%inserted_slice_17 : tensor<2x5x4xf64>) {
    ^bb0(%in: f64, %in_30: f64, %out: f64):
      %153 = arith.mulf %in, %in_30 : f64
      %154 = arith.addf %out, %153 : f64
      linalg.yield %154 : f64
    ...
    %122 = linalg.generic {doc = "", indexing_maps = [#map], iterator_types = ["parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_18 : tensor<?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?xf64>
    ...
    %124 = linalg.generic {doc = "", indexing_maps = [#map7, #map3, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice_19, %123 : tensor<?x?x?xf64>, tensor<?x?x?x?xf64>) outs(%122 : tensor<?x?x?xf64>) {
    ^bb0(%in: f64, %in_30: f64, %out: f64):
      %153 = arith.mulf %in, %in_30 : f64
      %154 = arith.addf %out, %153 : f64
      linalg.yield %154 : f64
    ...
    %125 = linalg.generic {doc = "", indexing_maps = [#map], iterator_types = ["parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_20 : tensor<?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?xf64>
    ...
    %127 = linalg.generic {doc = "", indexing_maps = [#map7, #map3, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice_21, %126 : tensor<?x?x?xf64>, tensor<?x?x?x?xf64>) outs(%125 : tensor<?x?x?xf64>) {
    ^bb0(%in: f64, %in_30: f64, %out: f64):
      %153 = arith.mulf %in, %in_30 : f64
      %154 = arith.addf %out, %153 : f64
      linalg.yield %154 : f64
    ...
    %138 = linalg.generic {doc = "", indexing_maps = [#map3, #map3, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%136, %137 : tensor<?x?x?x?xf64>, tensor<?x?x?x?xf64>) outs(%inserted_slice_23 : tensor<2x5x4xf64>) {
    ^bb0(%in: f64, %in_30: f64, %out: f64):
      %153 = arith.mulf %in, %in_30 : f64
      %154 = arith.addf %out, %153 : f64
      linalg.yield %154 : f64
    ...
    %142 = linalg.generic {doc = "", indexing_maps = [#map3, #map3, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%140, %141 : tensor<?x?x?x?xf64>, tensor<?x?x?x?xf64>) outs(%inserted_slice_25 : tensor<2x5x4xf64>) {
    ^bb0(%in: f64, %in_30: f64, %out: f64):
      %153 = arith.mulf %in, %in_30 : f64
      %154 = arith.addf %out, %153 : f64
      linalg.yield %154 : f64
    ...
    %143 = linalg.generic {doc = "", indexing_maps = [#map], iterator_types = ["parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_26 : tensor<?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?xf64>
    ...
    %145 = linalg.generic {doc = "", indexing_maps = [#map7, #map3, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice_27, %144 : tensor<?x?x?xf64>, tensor<?x?x?x?xf64>) outs(%143 : tensor<?x?x?xf64>) {
    ^bb0(%in: f64, %in_30: f64, %out: f64):
      %153 = arith.mulf %in, %in_30 : f64
      %154 = arith.addf %out, %153 : f64
      linalg.yield %154 : f64
    ...
    %146 = linalg.generic {doc = "", indexing_maps = [#map], iterator_types = ["parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_28 : tensor<?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?xf64>
    ...
    %148 = linalg.generic {doc = "", indexing_maps = [#map7, #map3, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice_29, %147 : tensor<?x?x?xf64>, tensor<?x?x?x?xf64>) outs(%146 : tensor<?x?x?xf64>) {
    ^bb0(%in: f64, %in_30: f64, %out: f64):
      %153 = arith.mulf %in, %in_30 : f64
      %154 = arith.addf %out, %153 : f64
      linalg.yield %154 : f64
