...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @mfem_app_dfem_minimal_surface_2d(%arg0: memref<?xf64>, %arg1: memref<?xf64>, %arg2: memref<?xf64>, %arg3: memref<?xf64>, %arg4: memref<?xf64>, %arg5: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %10 = linalg.generic {doc = "", indexing_maps = [#map], iterator_types = ["parallel", "parallel", "parallel"], library_call = ""} outs(%9 : tensor<2x4x5xf64>) {
    ^bb0(%out: f64):
    ...
    %13 = linalg.generic {doc = "", indexing_maps = [#map3, #map3, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%12, %11 : tensor<?x?x?x?xf64>, tensor<?x?x?x?xf64>) outs(%10 : tensor<2x4x5xf64>) {
    ^bb0(%in: f64, %in_1: f64, %out: f64):
      %55 = arith.mulf %in, %in_1 : f64
      %56 = arith.addf %out, %55 : f64
      linalg.yield %56 : f64
    } -> tensor<2x4x5xf64>
    %14 = linalg.generic {doc = "", indexing_maps = [#map], iterator_types = ["parallel", "parallel", "parallel"], library_call = ""} outs(%8 : tensor<2x4x5xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst_0 : f64
    } -> tensor<2x4x5xf64>
    ...
    %17 = linalg.generic {doc = "", indexing_maps = [#map3, #map3, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%16, %15 : tensor<?x?x?x?xf64>, tensor<?x?x?x?xf64>) outs(%14 : tensor<2x4x5xf64>) {
    ^bb0(%in: f64, %in_1: f64, %out: f64):
      %55 = arith.mulf %in, %in_1 : f64
      %56 = arith.addf %out, %55 : f64
      linalg.yield %56 : f64
    ...
    %23 = linalg.generic {doc = "", indexing_maps = [#map8, #map3, #map3], iterator_types = ["parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%17, %22 : tensor<2x4x5xf64>, tensor<?x?x?x?xf64>) outs(%21 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_1: f64, %out: f64):
      %55 = arith.mulf %in, %in_1 : f64
      %56 = arith.addf %out, %55 : f64
      linalg.yield %56 : f64
    ...
    %30 = linalg.generic {doc = "", indexing_maps = [#map8, #map3, #map3], iterator_types = ["parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%13, %29 : tensor<2x4x5xf64>, tensor<?x?x?x?xf64>) outs(%28 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_1: f64, %out: f64):
      %55 = arith.mulf %in, %in_1 : f64
      %56 = arith.addf %out, %55 : f64
      linalg.yield %56 : f64
    ...
    %37 = linalg.generic {doc = "", indexing_maps = [#map], iterator_types = ["parallel", "parallel", "parallel"], library_call = ""} outs(%36 : tensor<2x5x4xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst_0 : f64
    } -> tensor<2x5x4xf64>
    ...
    %40 = linalg.generic {doc = "", indexing_maps = [#map3, #map3, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%38, %39 : tensor<?x?x?x?xf64>, tensor<?x?x?x?xf64>) outs(%37 : tensor<2x5x4xf64>) {
    ^bb0(%in: f64, %in_1: f64, %out: f64):
      %55 = arith.mulf %in, %in_1 : f64
      %56 = arith.addf %out, %55 : f64
      linalg.yield %56 : f64
    } -> tensor<2x5x4xf64>
    %41 = linalg.generic {doc = "", indexing_maps = [#map], iterator_types = ["parallel", "parallel", "parallel"], library_call = ""} outs(%35 : tensor<2x5x4xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst_0 : f64
    } -> tensor<2x5x4xf64>
    ...
    %44 = linalg.generic {doc = "", indexing_maps = [#map3, #map3, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%42, %43 : tensor<?x?x?x?xf64>, tensor<?x?x?x?xf64>) outs(%41 : tensor<2x5x4xf64>) {
    ^bb0(%in: f64, %in_1: f64, %out: f64):
      %55 = arith.mulf %in, %in_1 : f64
      %56 = arith.addf %out, %55 : f64
      linalg.yield %56 : f64
    } -> tensor<2x5x4xf64>
    %45 = linalg.generic {doc = "", indexing_maps = [#map], iterator_types = ["parallel", "parallel", "parallel"], library_call = ""} outs(%34 : tensor<2x4x4xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst_0 : f64
    } -> tensor<2x4x4xf64>
    %46 = polygeist.submap(%5, %c2, %c4, %c4, %c5) {map = #map22} : (tensor<?xf64>, index, index, index, index) -> tensor<?x?x?x?xf64>
    %47 = linalg.generic {doc = "", indexing_maps = [#map8, #map3, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%40, %46 : tensor<2x5x4xf64>, tensor<?x?x?x?xf64>) outs(%45 : tensor<2x4x4xf64>) {
    ^bb0(%in: f64, %in_1: f64, %out: f64):
      %55 = arith.mulf %in, %in_1 : f64
      %56 = arith.addf %out, %55 : f64
      linalg.yield %56 : f64
    } -> tensor<2x4x4xf64>
    %48 = linalg.generic {doc = "", indexing_maps = [#map], iterator_types = ["parallel", "parallel", "parallel"], library_call = ""} outs(%33 : tensor<2x4x4xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst_0 : f64
    } -> tensor<2x4x4xf64>
    %49 = polygeist.submap(%4, %c2, %c4, %c4, %c5) {map = #map22} : (tensor<?xf64>, index, index, index, index) -> tensor<?x?x?x?xf64>
    %50 = linalg.generic {doc = "", indexing_maps = [#map8, #map3, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%44, %49 : tensor<2x5x4xf64>, tensor<?x?x?x?xf64>) outs(%48 : tensor<2x4x4xf64>) {
    ^bb0(%in: f64, %in_1: f64, %out: f64):
      %55 = arith.mulf %in, %in_1 : f64
      %56 = arith.addf %out, %55 : f64
      linalg.yield %56 : f64
    ...
    %52 = linalg.generic {doc = "", indexing_maps = [#map, #map, #map], iterator_types = ["parallel", "parallel", "parallel"], library_call = ""} ins(%47, %50 : tensor<2x4x4xf64>, tensor<2x4x4xf64>) outs(%51 : tensor<?x?x?xf64>) {
    ^bb0(%in: f64, %in_1: f64, %out: f64):
