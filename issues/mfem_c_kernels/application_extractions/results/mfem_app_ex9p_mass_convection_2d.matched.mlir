...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @mfem_app_ex9p_mass_convection_2d(%arg0: memref<?xf64>, %arg1: memref<?xf64>, %arg2: memref<?xf64>, %arg3: memref<?xf64>, %arg4: memref<?xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>, %arg7: f64, %arg8: f64, %arg9: memref<?xf64>, %arg10: memref<?xf64>, %arg11: memref<?xf64>, %arg12: memref<?xf64>, %arg13: memref<?xf64>, %arg14: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %v17_contract_19_tc0 = tensor.cast %17 : tensor<?x?x?x?xf64> to tensor<*xf64>

    %v18_contract_19_tc1 = tensor.cast %18 : tensor<?x?x?x?xf64> to tensor<*xf64>

    %inserted_slice_contract_19_tc2 = tensor.cast %inserted_slice : tensor<2x4x5xf64> to tensor<*xf64>

    %v19_tdyn = kernel.launch @cutensornetContraction2_f64(%v17_contract_19_tc0, %v18_contract_19_tc1, %inserted_slice_contract_19_tc2) {contraction_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d1, d2)>]} : (tensor<*xf64>, tensor<*xf64>, tensor<*xf64>) -> tensor<*xf64>
    ...
    %extracted_slice_1_contract_22_tc1 = tensor.cast %extracted_slice_1 : tensor<?x?x?xf64> to tensor<*xf64>

    %extracted_slice_0_contract_22_tc2 = tensor.cast %extracted_slice_0 : tensor<?x?x?xf64> to tensor<*xf64>

    %v22_tdyn = kernel.launch @cutensornetContraction2_f64(%v21_contract_22_tc0, %extracted_slice_1_contract_22_tc1, %extracted_slice_0_contract_22_tc2) {contraction_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d3, d2)>, affine_map<(d0, d1, d2, d3) -> (d0, d1, d2)>]} : (tensor<*xf64>, tensor<*xf64>, tensor<*xf64>) -> tensor<*xf64>

    %22 = tensor.cast %v22_tdyn : tensor<*xf64> to tensor<?x?x?xf64>
    ...
    %v26_contract_27_tc0 = tensor.cast %26 : tensor<?x?x?x?xf64> to tensor<*xf64>

    %v24_contract_27_tc1 = tensor.cast %24 : tensor<?x?x?xf64> to tensor<*xf64>

    %extracted_slice_2_contract_27_tc2 = tensor.cast %extracted_slice_2 : tensor<?x?x?xf64> to tensor<*xf64>

    %v27_tdyn = kernel.launch @cutensornetContraction2_f64(%v26_contract_27_tc0, %v24_contract_27_tc1, %extracted_slice_2_contract_27_tc2) {contraction_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d1, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d1, d2)>]} : (tensor<*xf64>, tensor<*xf64>, tensor<*xf64>) -> tensor<*xf64>

    %27 = tensor.cast %v27_tdyn : tensor<*xf64> to tensor<?x?x?xf64>
    ...
    %v41_contract_42_tc0 = tensor.cast %41 : tensor<?x?x?x?xf64> to tensor<*xf64>

    %v40_contract_42_tc1 = tensor.cast %40 : tensor<?x?x?x?xf64> to tensor<*xf64>

    %inserted_slice_4_contract_42_tc2 = tensor.cast %inserted_slice_4 : tensor<2x4x5xf64> to tensor<*xf64>

    %v42_tdyn = kernel.launch @cutensornetContraction2_f64(%v41_contract_42_tc0, %v40_contract_42_tc1, %inserted_slice_4_contract_42_tc2) {contraction_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d1, d2)>]} : (tensor<*xf64>, tensor<*xf64>, tensor<*xf64>) -> tensor<*xf64>

    %42 = tensor.cast %v42_tdyn : tensor<*xf64> to tensor<2x4x5xf64>
    ...
    %v45_contract_46_tc0 = tensor.cast %45 : tensor<?x?x?x?xf64> to tensor<*xf64>

    %v44_contract_46_tc1 = tensor.cast %44 : tensor<?x?x?x?xf64> to tensor<*xf64>

    %inserted_slice_6_contract_46_tc2 = tensor.cast %inserted_slice_6 : tensor<2x4x5xf64> to tensor<*xf64>

    %v46_tdyn = kernel.launch @cutensornetContraction2_f64(%v45_contract_46_tc0, %v44_contract_46_tc1, %inserted_slice_6_contract_46_tc2) {contraction_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d1, d2)>]} : (tensor<*xf64>, tensor<*xf64>, tensor<*xf64>) -> tensor<*xf64>

    %46 = tensor.cast %v46_tdyn : tensor<*xf64> to tensor<2x4x5xf64>
    ...
    %extracted_slice_7_contract_49_tc2 = tensor.cast %extracted_slice_7 : tensor<?x?x?xf64> to tensor<*xf64>

    %v49_tdyn = kernel.launch @cutensornetContraction2_f64(%extracted_slice_8_contract_49_tc0, %v48_contract_49_tc1, %extracted_slice_7_contract_49_tc2) {contraction_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d3, d1)>, affine_map<(d0, d1, d2, d3) -> (d0, d2, d1, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d2, d1)>]} : (tensor<*xf64>, tensor<*xf64>, tensor<*xf64>) -> tensor<*xf64>

    %49 = tensor.cast %v49_tdyn : tensor<*xf64> to tensor<?x?x?xf64>
    ...
    %extracted_slice_10_contract_52_tc0 = tensor.cast %extracted_slice_10 : tensor<?x?x?xf64> to tensor<*xf64>

    %v51_contract_52_tc1 = tensor.cast %51 : tensor<?x?x?x?xf64> to tensor<*xf64>

    %extracted_slice_9_contract_52_tc2 = tensor.cast %extracted_slice_9 : tensor<?x?x?xf64> to tensor<*xf64>

    %v52_tdyn = kernel.launch @cutensornetContraction2_f64(%extracted_slice_10_contract_52_tc0, %v51_contract_52_tc1, %extracted_slice_9_contract_52_tc2) {contraction_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d3, d1)>, affine_map<(d0, d1, d2, d3) -> (d0, d2, d1, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d2, d1)>]} : (tensor<*xf64>, tensor<*xf64>, tensor<*xf64>) -> tensor<*xf64>

    %52 = tensor.cast %v52_tdyn : tensor<*xf64> to tensor<?x?x?xf64>
    ...
    %v57_contract_60_tc0 = tensor.cast %57 : tensor<?x?x?xf64> to tensor<*xf64>

    %v59_contract_60_tc1 = tensor.cast %59 : tensor<?x?x?x?xf64> to tensor<*xf64>

    %extracted_slice_12_contract_60_tc2 = tensor.cast %extracted_slice_12 : tensor<?x?x?xf64> to tensor<*xf64>

    %v60_tdyn = kernel.launch @cutensornetContraction2_f64(%v57_contract_60_tc0, %v59_contract_60_tc1, %extracted_slice_12_contract_60_tc2) {contraction_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d3, d1)>, affine_map<(d0, d1, d2, d3) -> (d0, d2, d1, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d2, d1)>]} : (tensor<*xf64>, tensor<*xf64>, tensor<*xf64>) -> tensor<*xf64>

    %60 = tensor.cast %v60_tdyn : tensor<*xf64> to tensor<?x?x?xf64>
    %61 = polygeist.submap(%4, %c2, %c4, %c4) {map = #map11} : (tensor<?xf64>, index, index, index) -> tensor<?x?x?xf64>
    %62 = kernel.launch @cublasDaxpby(%60, %61) : (tensor<?x?x?xf64>, tensor<?x?x?xf64>) -> tensor<?x?x?xf64>
    ...
    %69 = kernel.launch @cublasDaxpby(%inserted_slice_22, %1, %arg8) : (tensor<?xf64>, tensor<?xf64>, f64) -> tensor<?xf64>
