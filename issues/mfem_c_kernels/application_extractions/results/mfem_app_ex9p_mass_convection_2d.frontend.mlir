  ...
  func.func @mfem_app_ex9p_mass_convection_2d(%arg0: memref<?xf64>, %arg1: memref<?xf64>, %arg2: memref<?xf64>, %arg3: memref<?xf64>, %arg4: memref<?xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>, %arg7: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
      ...
      affine.for %arg9 = 0 to 4 {
        affine.for %arg10 = 0 to 5 {
          %0 = affine.for %arg11 = 0 to 4 iter_args(%arg12 = %cst) -> (f64) {
            %1 = affine.load %arg0[%arg11 + %arg10 * 4] : memref<?xf64>
            %2 = affine.load %arg5[%arg11 + %arg8 * 16 + %arg9 * 4] : memref<?xf64>
    ...
    affine.for %arg8 = 0 to 2 {
      affine.for %arg9 = 0 to 5 {
        affine.for %arg10 = 0 to 5 {
          %0 = affine.for %arg11 = 0 to 4 iter_args(%arg12 = %cst) -> (f64) {
            %1 = affine.load %arg0[%arg11 + %arg9 * 4] : memref<?xf64>
            %2 = affine.load %alloca_1[%arg8, %arg11, %arg10] : memref<2x4x5xf64>
            %3 = arith.mulf %1, %2 : f64
            %4 = arith.addf %arg12, %3 : f64
            affine.yield %4 : f64
          }
          affine.store %0, %alloca_0[%arg8, %arg9, %arg10] : memref<2x5x5xf64>
        }
      }
    }
    affine.for %arg8 = 0 to 2 {
      affine.for %arg9 = 0 to 5 {
        affine.for %arg10 = 0 to 5 {
          %0 = affine.load %arg3[%arg10 + %arg8 * 25 + %arg9 * 5] : memref<?xf64>
          %1 = affine.load %alloca_0[%arg8, %arg9, %arg10] : memref<2x5x5xf64>
          %2 = arith.mulf %1, %0 : f64
          affine.store %2, %alloca_0[%arg8, %arg9, %arg10] : memref<2x5x5xf64>
        }
      }
    }
    affine.for %arg8 = 0 to 2 {
      affine.for %arg9 = 0 to 5 {
        affine.for %arg10 = 0 to 4 {
          %0 = affine.for %arg11 = 0 to 5 iter_args(%arg12 = %cst) -> (f64) {
            %1 = affine.load %arg2[%arg11 + %arg10 * 5] : memref<?xf64>
            %2 = affine.load %alloca_0[%arg8, %arg9, %arg11] : memref<2x5x5xf64>
            %3 = arith.mulf %1, %2 : f64
            %4 = arith.addf %arg12, %3 : f64
            affine.yield %4 : f64
          }
          affine.store %0, %alloca[%arg8, %arg9, %arg10] : memref<2x5x4xf64>
        }
      }
    }
    affine.for %arg8 = 0 to 2 {
      affine.for %arg9 = 0 to 4 {
        affine.for %arg10 = 0 to 4 {
          %0 = affine.for %arg11 = 0 to 5 iter_args(%arg12 = %cst) -> (f64) {
            %3 = affine.load %arg2[%arg11 + %arg9 * 5] : memref<?xf64>
            %4 = affine.load %alloca[%arg8, %arg11, %arg10] : memref<2x5x4xf64>
            %5 = arith.mulf %3, %4 : f64
            %6 = arith.addf %arg12, %5 : f64
            affine.yield %6 : f64
          }
          %1 = affine.load %arg6[%arg10 + %arg8 * 16 + %arg9 * 4] : memref<?xf64>
          %2 = arith.addf %1, %0 : f64
          affine.store %2, %arg6[%arg10 + %arg8 * 16 + %arg9 * 4] : memref<?xf64>
        }
      }
    }
    ...
    affine.for %arg8 = 0 to 2 {
      affine.for %arg9 = 0 to 4 {
        affine.for %arg10 = 0 to 5 {
          %0 = affine.for %arg11 = 0 to 4 iter_args(%arg12 = %cst) -> (f64) {
            %1 = affine.load %arg5[%arg11 + %arg8 * 16 + %arg9 * 4] : memref<?xf64>
            %2 = affine.load %arg0[%arg11 + %arg10 * 4] : memref<?xf64>
            %3 = arith.mulf %1, %2 : f64
            %4 = arith.addf %arg12, %3 : f64
            affine.yield %4 : f64
          }
          affine.store %0, %alloca_7[%arg8, %arg9, %arg10] : memref<2x4x5xf64>
        }
      }
    }
    affine.for %arg8 = 0 to 2 {
      affine.for %arg9 = 0 to 4 {
        affine.for %arg10 = 0 to 5 {
          ...
          affine.store %0, %alloca_6[%arg8, %arg9, %arg10] : memref<2x4x5xf64>
        }
      }
    }
    affine.for %arg8 = 0 to 2 {
      affine.for %arg9 = 0 to 5 {
        affine.for %arg10 = 0 to 5 {
          %0 = affine.for %arg11 = 0 to 4 iter_args(%arg12 = %cst) -> (f64) {
            %1 = affine.load %alloca_6[%arg8, %arg11, %arg10] : memref<2x4x5xf64>
            %2 = affine.load %arg0[%arg11 + %arg9 * 4] : memref<?xf64>
            %3 = arith.mulf %1, %2 : f64
            %4 = arith.addf %arg12, %3 : f64
            affine.yield %4 : f64
          }
          affine.store %0, %alloca_5[%arg8, %arg9, %arg10] : memref<2x5x5xf64>
        }
      }
    }
    affine.for %arg8 = 0 to 2 {
      affine.for %arg9 = 0 to 5 {
        affine.for %arg10 = 0 to 5 {
          %0 = affine.for %arg11 = 0 to 4 iter_args(%arg12 = %cst) -> (f64) {
            %1 = affine.load %alloca_7[%arg8, %arg11, %arg10] : memref<2x4x5xf64>
            %2 = affine.load %arg1[%arg11 + %arg9 * 4] : memref<?xf64>
            %3 = arith.mulf %1, %2 : f64
            %4 = arith.addf %arg12, %3 : f64
            affine.yield %4 : f64
          }
          affine.store %0, %alloca_4[%arg8, %arg9, %arg10] : memref<2x5x5xf64>
        }
      }
    }
    affine.for %arg8 = 0 to 2 {
      affine.for %arg9 = 0 to 5 {
        affine.for %arg10 = 0 to 4 {
          %0 = affine.for %arg11 = 0 to 5 iter_args(%arg12 = %cst) -> (f64) {
            %1 = affine.load %arg4[%arg11 + %arg8 * 50 + %arg9 * 5] : memref<?xf64>
            %2 = affine.load %alloca_5[%arg8, %arg9, %arg11] : memref<2x5x5xf64>
            %3 = arith.mulf %1, %2 : f64
            %4 = affine.load %arg4[%arg11 + %arg8 * 50 + %arg9 * 5 + 25] : memref<?xf64>
            %5 = affine.load %alloca_4[%arg8, %arg9, %arg11] : memref<2x5x5xf64>
            %6 = arith.mulf %4, %5 : f64
            %7 = arith.addf %3, %6 : f64
            %8 = affine.load %arg2[%arg11 + %arg10 * 5] : memref<?xf64>
            %9 = arith.mulf %7, %8 : f64
            %10 = arith.addf %arg12, %9 : f64
            affine.yield %10 : f64
          }
          affine.store %0, %alloca_3[%arg8, %arg9, %arg10] : memref<2x5x4xf64>
        }
      }
    }
    affine.for %arg8 = 0 to 2 {
      affine.for %arg9 = 0 to 4 {
        affine.for %arg10 = 0 to 4 {
          %0 = affine.for %arg11 = 0 to 5 iter_args(%arg12 = %cst) -> (f64) {
            %1 = affine.load %alloca_3[%arg8, %arg11, %arg10] : memref<2x5x4xf64>
            %2 = affine.load %arg2[%arg11 + %arg9 * 5] : memref<?xf64>
            %3 = arith.mulf %1, %2 : f64
            %4 = arith.addf %arg12, %3 : f64
            affine.yield %4 : f64
          }
          affine.store %0, %alloca_2[%arg8, %arg9, %arg10] : memref<2x4x4xf64>
        }
      }
    }
    affine.for %arg8 = 0 to 2 {
      affine.for %arg9 = 0 to 4 {
        affine.for %arg10 = 0 to 4 {
          %0 = affine.load %alloca_2[%arg8, %arg9, %arg10] : memref<2x4x4xf64>
          %1 = affine.load %arg7[%arg10 + %arg8 * 16 + %arg9 * 4] : memref<?xf64>
          %2 = arith.addf %1, %0 : f64
          affine.store %2, %arg7[%arg10 + %arg8 * 16 + %arg9 * 4] : memref<?xf64>
        }
      }
    }
    return
