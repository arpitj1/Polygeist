...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @mfem_app_navier_tgv_pa_operators_3d(%arg0: memref<?xf64>, %arg1: memref<?xf64>, %arg2: memref<?xf64>, %arg3: memref<?xf64>, %arg4: memref<?xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>, %arg7: memref<?xf64>, %arg8: memref<?xf64>, %arg9: memref<?xf64>, %arg10: memref<?xf64>, %arg11: memref<?xf64>, %arg12: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %37 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_0 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    ...
    %39 = linalg.generic {doc = "", indexing_maps = [#map8, #map11, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%38, %extracted_slice_1 : tensor<?x?x?x?x?xf64>, tensor<?x?x?x?xf64>) outs(%37 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %40 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_2 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    %41 = polygeist.submap(%0, %c2, %c5, %c5, %c5, %c4) {map = #map12} : (tensor<?xf64>, index, index, index, index, index) -> tensor<?x?x?x?x?xf64>
    %42 = linalg.generic {doc = "", indexing_maps = [#map8, #map13, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%41, %39 : tensor<?x?x?x?x?xf64>, tensor<?x?x?x?xf64>) outs(%40 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %78 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_7 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    ...
    %80 = linalg.generic {doc = "", indexing_maps = [#map8, #map11, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%79, %extracted_slice_8 : tensor<?x?x?x?x?xf64>, tensor<?x?x?x?xf64>) outs(%78 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %81 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_9 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    %82 = polygeist.submap(%0, %c2, %c5, %c5, %c5, %c4) {map = #map12} : (tensor<?xf64>, index, index, index, index, index) -> tensor<?x?x?x?x?xf64>
    %83 = linalg.generic {doc = "", indexing_maps = [#map8, #map13, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%82, %80 : tensor<?x?x?x?x?xf64>, tensor<?x?x?x?xf64>) outs(%81 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %119 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_14 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    ...
    %121 = linalg.generic {doc = "", indexing_maps = [#map8, #map11, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%120, %extracted_slice_15 : tensor<?x?x?x?x?xf64>, tensor<?x?x?x?xf64>) outs(%119 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %122 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_16 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    %123 = polygeist.submap(%0, %c2, %c5, %c5, %c5, %c4) {map = #map12} : (tensor<?xf64>, index, index, index, index, index) -> tensor<?x?x?x?x?xf64>
    %124 = linalg.generic {doc = "", indexing_maps = [#map8, #map13, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%123, %121 : tensor<?x?x?x?x?xf64>, tensor<?x?x?x?xf64>) outs(%122 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %191 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_23 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    ...
    %193 = linalg.generic {doc = "", indexing_maps = [#map11, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice_24, %192 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%191 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %194 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_25 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    ...
    %196 = linalg.generic {doc = "", indexing_maps = [#map11, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice_26, %195 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%194 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %197 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_27 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    ...
    %199 = linalg.generic {doc = "", indexing_maps = [#map11, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice_28, %198 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%197 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %200 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_29 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    %201 = polygeist.submap(%0, %c2, %c5, %c5, %c5, %c4) {map = #map12} : (tensor<?xf64>, index, index, index, index, index) -> tensor<?x?x?x?x?xf64>
    %202 = linalg.generic {doc = "", indexing_maps = [#map13, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%193, %201 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%200 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %203 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_30 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    %204 = polygeist.submap(%0, %c2, %c5, %c5, %c5, %c4) {map = #map12} : (tensor<?xf64>, index, index, index, index, index) -> tensor<?x?x?x?x?xf64>
    %205 = linalg.generic {doc = "", indexing_maps = [#map13, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%196, %204 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%203 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %206 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_31 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    %207 = polygeist.submap(%1, %c2, %c5, %c5, %c5, %c4) {map = #map12} : (tensor<?xf64>, index, index, index, index, index) -> tensor<?x?x?x?x?xf64>
    %208 = linalg.generic {doc = "", indexing_maps = [#map13, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%199, %207 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%206 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %292 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_45 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    ...
    %294 = linalg.generic {doc = "", indexing_maps = [#map11, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice_46, %293 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%292 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %295 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_47 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    ...
    %297 = linalg.generic {doc = "", indexing_maps = [#map11, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice_48, %296 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%295 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %298 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_49 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    ...
    %300 = linalg.generic {doc = "", indexing_maps = [#map11, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice_50, %299 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%298 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %301 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_51 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    %302 = polygeist.submap(%0, %c2, %c5, %c5, %c5, %c4) {map = #map12} : (tensor<?xf64>, index, index, index, index, index) -> tensor<?x?x?x?x?xf64>
    %303 = linalg.generic {doc = "", indexing_maps = [#map13, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%294, %302 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%301 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %304 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_52 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    %305 = polygeist.submap(%0, %c2, %c5, %c5, %c5, %c4) {map = #map12} : (tensor<?xf64>, index, index, index, index, index) -> tensor<?x?x?x?x?xf64>
    %306 = linalg.generic {doc = "", indexing_maps = [#map13, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%297, %305 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%304 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %307 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_53 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    %308 = polygeist.submap(%1, %c2, %c5, %c5, %c5, %c4) {map = #map12} : (tensor<?xf64>, index, index, index, index, index) -> tensor<?x?x?x?x?xf64>
    %309 = linalg.generic {doc = "", indexing_maps = [#map13, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%300, %308 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%307 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %393 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_67 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    ...
    %395 = linalg.generic {doc = "", indexing_maps = [#map11, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice_68, %394 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%393 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %396 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_69 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    ...
    %398 = linalg.generic {doc = "", indexing_maps = [#map11, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice_70, %397 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%396 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %399 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_71 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    ...
    %401 = linalg.generic {doc = "", indexing_maps = [#map11, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice_72, %400 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%399 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %402 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_73 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    %403 = polygeist.submap(%0, %c2, %c5, %c5, %c5, %c4) {map = #map12} : (tensor<?xf64>, index, index, index, index, index) -> tensor<?x?x?x?x?xf64>
    %404 = linalg.generic {doc = "", indexing_maps = [#map13, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%395, %403 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%402 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %405 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_74 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    %406 = polygeist.submap(%0, %c2, %c5, %c5, %c5, %c4) {map = #map12} : (tensor<?xf64>, index, index, index, index, index) -> tensor<?x?x?x?x?xf64>
    %407 = linalg.generic {doc = "", indexing_maps = [#map13, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%398, %406 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%405 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %408 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_75 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    %409 = polygeist.submap(%1, %c2, %c5, %c5, %c5, %c4) {map = #map12} : (tensor<?xf64>, index, index, index, index, index) -> tensor<?x?x?x?x?xf64>
    %410 = linalg.generic {doc = "", indexing_maps = [#map13, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%401, %409 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%408 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %475 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_87 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    ...
    %477 = linalg.generic {doc = "", indexing_maps = [#map11, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice_88, %476 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%475 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %483 = linalg.generic {doc = "", indexing_maps = [#map13, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%477, %481 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%482 : tensor<2x5x5x5xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %498 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_93 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    ...
    %500 = linalg.generic {doc = "", indexing_maps = [#map11, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice_94, %499 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%498 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %501 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_95 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    ...
    %503 = linalg.generic {doc = "", indexing_maps = [#map11, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice_96, %502 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%501 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %504 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_97 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    ...
    %506 = linalg.generic {doc = "", indexing_maps = [#map11, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice_98, %505 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%504 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %512 = linalg.generic {doc = "", indexing_maps = [#map13, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%500, %510 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%511 : tensor<2x5x5x5xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %519 = linalg.generic {doc = "", indexing_maps = [#map13, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%503, %517 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%518 : tensor<2x5x5x5xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %526 = linalg.generic {doc = "", indexing_maps = [#map13, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%506, %524 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%525 : tensor<2x5x5x5xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %549 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_101 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    ...
    %551 = linalg.generic {doc = "", indexing_maps = [#map11, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice_102, %550 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%549 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %557 = linalg.generic {doc = "", indexing_maps = [#map13, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%551, %555 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%556 : tensor<2x5x5x5xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %572 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_107 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    ...
    %574 = linalg.generic {doc = "", indexing_maps = [#map11, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice_108, %573 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%572 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %575 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_109 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    ...
    %577 = linalg.generic {doc = "", indexing_maps = [#map11, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice_110, %576 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%575 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %578 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_111 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    ...
    %580 = linalg.generic {doc = "", indexing_maps = [#map11, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice_112, %579 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%578 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %586 = linalg.generic {doc = "", indexing_maps = [#map13, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%574, %584 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%585 : tensor<2x5x5x5xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %593 = linalg.generic {doc = "", indexing_maps = [#map13, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%577, %591 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%592 : tensor<2x5x5x5xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %600 = linalg.generic {doc = "", indexing_maps = [#map13, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%580, %598 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%599 : tensor<2x5x5x5xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %623 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_115 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    ...
    %625 = linalg.generic {doc = "", indexing_maps = [#map11, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice_116, %624 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%623 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %631 = linalg.generic {doc = "", indexing_maps = [#map13, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%625, %629 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%630 : tensor<2x5x5x5xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %646 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_121 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    ...
    %648 = linalg.generic {doc = "", indexing_maps = [#map11, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice_122, %647 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%646 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %649 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_123 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    ...
    %651 = linalg.generic {doc = "", indexing_maps = [#map11, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice_124, %650 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%649 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %652 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_125 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    ...
    %654 = linalg.generic {doc = "", indexing_maps = [#map11, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice_126, %653 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%652 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %660 = linalg.generic {doc = "", indexing_maps = [#map13, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%648, %658 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%659 : tensor<2x5x5x5xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %667 = linalg.generic {doc = "", indexing_maps = [#map13, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%651, %665 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%666 : tensor<2x5x5x5xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %674 = linalg.generic {doc = "", indexing_maps = [#map13, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%654, %672 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%673 : tensor<2x5x5x5xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %803 = linalg.generic {doc = "", indexing_maps = [#map8, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%801, %802 : tensor<?x?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%inserted_slice_143 : tensor<2x4x4x5xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %807 = linalg.generic {doc = "", indexing_maps = [#map8, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%805, %806 : tensor<?x?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%inserted_slice_145 : tensor<2x4x4x5xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %808 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_146 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    ...
    %810 = linalg.generic {doc = "", indexing_maps = [#map11, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice_147, %809 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%808 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %811 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_148 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    ...
    %813 = linalg.generic {doc = "", indexing_maps = [#map11, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice_149, %812 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%811 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %814 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_150 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    ...
    %816 = linalg.generic {doc = "", indexing_maps = [#map11, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice_151, %815 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%814 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %817 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_152 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    %818 = polygeist.submap(%0, %c2, %c5, %c5, %c5, %c4) {map = #map12} : (tensor<?xf64>, index, index, index, index, index) -> tensor<?x?x?x?x?xf64>
    %819 = linalg.generic {doc = "", indexing_maps = [#map13, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%810, %818 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%817 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %820 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_153 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    %821 = polygeist.submap(%0, %c2, %c5, %c5, %c5, %c4) {map = #map12} : (tensor<?xf64>, index, index, index, index, index) -> tensor<?x?x?x?x?xf64>
    %822 = linalg.generic {doc = "", indexing_maps = [#map13, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%813, %821 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%820 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %823 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_154 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    %824 = polygeist.submap(%1, %c2, %c5, %c5, %c5, %c4) {map = #map12} : (tensor<?xf64>, index, index, index, index, index) -> tensor<?x?x?x?x?xf64>
    %825 = linalg.generic {doc = "", indexing_maps = [#map13, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%816, %824 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%823 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %844 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_158 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    %845 = polygeist.submap(%2, %c2, %c5, %c4, %c4, %c5) {map = #map17} : (tensor<?xf64>, index, index, index, index, index) -> tensor<?x?x?x?x?xf64>
    %846 = linalg.generic {doc = "", indexing_maps = [#map11, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%831, %845 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%844 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %847 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_159 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    %848 = polygeist.submap(%3, %c2, %c5, %c4, %c4, %c5) {map = #map17} : (tensor<?xf64>, index, index, index, index, index) -> tensor<?x?x?x?x?xf64>
    %849 = linalg.generic {doc = "", indexing_maps = [#map11, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%837, %848 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%847 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %850 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_160 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    %851 = polygeist.submap(%2, %c2, %c5, %c4, %c4, %c5) {map = #map17} : (tensor<?xf64>, index, index, index, index, index) -> tensor<?x?x?x?x?xf64>
    %852 = linalg.generic {doc = "", indexing_maps = [#map11, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%843, %851 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%850 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %853 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_161 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    %854 = polygeist.submap(%2, %c2, %c4, %c4, %c4, %c5) {map = #map18} : (tensor<?xf64>, index, index, index, index, index) -> tensor<?x?x?x?x?xf64>
    %855 = linalg.generic {doc = "", indexing_maps = [#map13, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%846, %854 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%853 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %856 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_162 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    %857 = polygeist.submap(%2, %c2, %c4, %c4, %c4, %c5) {map = #map18} : (tensor<?xf64>, index, index, index, index, index) -> tensor<?x?x?x?x?xf64>
    %858 = linalg.generic {doc = "", indexing_maps = [#map13, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%849, %857 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%856 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %859 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_163 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    %860 = polygeist.submap(%3, %c2, %c4, %c4, %c4, %c5) {map = #map18} : (tensor<?xf64>, index, index, index, index, index) -> tensor<?x?x?x?x?xf64>
    %861 = linalg.generic {doc = "", indexing_maps = [#map13, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%852, %860 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%859 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %880 = linalg.generic {doc = "", indexing_maps = [#map8, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%878, %879 : tensor<?x?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%inserted_slice_165 : tensor<2x4x4x5xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %884 = linalg.generic {doc = "", indexing_maps = [#map8, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%882, %883 : tensor<?x?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%inserted_slice_167 : tensor<2x4x4x5xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %885 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_168 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    ...
    %887 = linalg.generic {doc = "", indexing_maps = [#map11, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice_169, %886 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%885 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %888 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_170 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    ...
    %890 = linalg.generic {doc = "", indexing_maps = [#map11, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice_171, %889 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%888 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %891 = linalg.generic {doc = "", indexing_maps = [#map5], iterator_types = ["parallel", "parallel", "parallel", "parallel"], library_call = ""} outs(%extracted_slice_172 : tensor<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<?x?x?x?xf64>
    ...
    %893 = linalg.generic {doc = "", indexing_maps = [#map11, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice_173, %892 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%891 : tensor<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %899 = linalg.generic {doc = "", indexing_maps = [#map13, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%887, %897 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%898 : tensor<2x5x5x5xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %906 = linalg.generic {doc = "", indexing_maps = [#map13, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%890, %904 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%905 : tensor<2x5x5x5xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
    ...
    %913 = linalg.generic {doc = "", indexing_maps = [#map13, #map8, #map9], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%893, %911 : tensor<?x?x?x?xf64>, tensor<?x?x?x?x?xf64>) outs(%912 : tensor<2x5x5x5xf64>) {
    ^bb0(%in: f64, %in_192: f64, %out: f64):
      %1034 = arith.mulf %in, %in_192 : f64
      %1035 = arith.addf %out, %1034 : f64
      linalg.yield %1035 : f64
