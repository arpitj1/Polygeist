...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @mfem_app_dfem_minimal_surface_2d(%arg0: memref<?xf64>, %arg1: memref<?xf64>, %arg2: memref<?xf64>, %arg3: memref<?xf64>, %arg4: memref<?xf64>, %arg5: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %inserted_slice_contract_13_tc2 = tensor.cast %inserted_slice : tensor<2x4x5xf64> to tensor<*xf64>

    %v13_tdyn = kernel.launch @cutensornetContraction2_f64(%v12_contract_13_tc0, %v11_contract_13_tc1, %inserted_slice_contract_13_tc2) {contraction_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d1, d2)>]} : (tensor<*xf64>, tensor<*xf64>, tensor<*xf64>) -> tensor<*xf64>
    ...
    %inserted_slice_2_contract_17_tc2 = tensor.cast %inserted_slice_2 : tensor<2x4x5xf64> to tensor<*xf64>

    %v17_tdyn = kernel.launch @cutensornetContraction2_f64(%v16_contract_17_tc0, %v15_contract_17_tc1, %inserted_slice_2_contract_17_tc2) {contraction_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d1, d2)>]} : (tensor<*xf64>, tensor<*xf64>, tensor<*xf64>) -> tensor<*xf64>
    ...
    %extracted_slice_3_contract_23_tc0 = tensor.cast %extracted_slice_3 : tensor<?x?x?xf64> to tensor<*xf64>

    %v22_contract_23_tc1 = tensor.cast %22 : tensor<?x?x?x?xf64> to tensor<*xf64>

    %v21_contract_23_tc2 = tensor.cast %21 : tensor<2x5x5xf64> to tensor<*xf64>

    %v23_tdyn = kernel.launch @cutensornetContraction2_f64(%extracted_slice_3_contract_23_tc0, %v22_contract_23_tc1, %v21_contract_23_tc2) {contraction_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d3, d1)>, affine_map<(d0, d1, d2, d3) -> (d0, d2, d1, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d2, d1)>]} : (tensor<*xf64>, tensor<*xf64>, tensor<*xf64>) -> tensor<*xf64>

    %23 = tensor.cast %v23_tdyn : tensor<*xf64> to tensor<2x5x5xf64>
    ...
    %extracted_slice_4_contract_30_tc0 = tensor.cast %extracted_slice_4 : tensor<?x?x?xf64> to tensor<*xf64>

    %v29_contract_30_tc1 = tensor.cast %29 : tensor<?x?x?x?xf64> to tensor<*xf64>

    %v28_contract_30_tc2 = tensor.cast %28 : tensor<2x5x5xf64> to tensor<*xf64>

    %v30_tdyn = kernel.launch @cutensornetContraction2_f64(%extracted_slice_4_contract_30_tc0, %v29_contract_30_tc1, %v28_contract_30_tc2) {contraction_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d3, d1)>, affine_map<(d0, d1, d2, d3) -> (d0, d2, d1, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d2, d1)>]} : (tensor<*xf64>, tensor<*xf64>, tensor<*xf64>) -> tensor<*xf64>

    %30 = tensor.cast %v30_tdyn : tensor<*xf64> to tensor<2x5x5xf64>
    ...
    %v50_contract_52_tc0 = tensor.cast %50 : tensor<?x?x?x?xf64> to tensor<*xf64>

    %v51_contract_52_tc1 = tensor.cast %51 : tensor<?x?x?x?xf64> to tensor<*xf64>

    %inserted_slice_6_contract_52_tc2 = tensor.cast %inserted_slice_6 : tensor<2x5x4xf64> to tensor<*xf64>

    %v52_tdyn = kernel.launch @cutensornetContraction2_f64(%v50_contract_52_tc0, %v51_contract_52_tc1, %inserted_slice_6_contract_52_tc2) {contraction_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d1, d2)>]} : (tensor<*xf64>, tensor<*xf64>, tensor<*xf64>) -> tensor<*xf64>

    %52 = tensor.cast %v52_tdyn : tensor<*xf64> to tensor<2x5x4xf64>
    ...
    %v54_contract_56_tc0 = tensor.cast %54 : tensor<?x?x?x?xf64> to tensor<*xf64>

    %v55_contract_56_tc1 = tensor.cast %55 : tensor<?x?x?x?xf64> to tensor<*xf64>

    %inserted_slice_8_contract_56_tc2 = tensor.cast %inserted_slice_8 : tensor<2x5x4xf64> to tensor<*xf64>

    %v56_tdyn = kernel.launch @cutensornetContraction2_f64(%v54_contract_56_tc0, %v55_contract_56_tc1, %inserted_slice_8_contract_56_tc2) {contraction_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d1, d2)>]} : (tensor<*xf64>, tensor<*xf64>, tensor<*xf64>) -> tensor<*xf64>

    %56 = tensor.cast %v56_tdyn : tensor<*xf64> to tensor<2x5x4xf64>
    ...
    %extracted_slice_10_contract_59_tc0 = tensor.cast %extracted_slice_10 : tensor<?x?x?xf64> to tensor<*xf64>

    %v58_contract_59_tc1 = tensor.cast %58 : tensor<?x?x?x?xf64> to tensor<*xf64>

    %extracted_slice_9_contract_59_tc2 = tensor.cast %extracted_slice_9 : tensor<?x?x?xf64> to tensor<*xf64>

    %v59_tdyn = kernel.launch @cutensornetContraction2_f64(%extracted_slice_10_contract_59_tc0, %v58_contract_59_tc1, %extracted_slice_9_contract_59_tc2) {contraction_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d3, d1)>, affine_map<(d0, d1, d2, d3) -> (d0, d2, d1, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d2, d1)>]} : (tensor<*xf64>, tensor<*xf64>, tensor<*xf64>) -> tensor<*xf64>

    %59 = tensor.cast %v59_tdyn : tensor<*xf64> to tensor<?x?x?xf64>
    ...
    %extracted_slice_12_contract_62_tc0 = tensor.cast %extracted_slice_12 : tensor<?x?x?xf64> to tensor<*xf64>

    %v61_contract_62_tc1 = tensor.cast %61 : tensor<?x?x?x?xf64> to tensor<*xf64>

    %extracted_slice_11_contract_62_tc2 = tensor.cast %extracted_slice_11 : tensor<?x?x?xf64> to tensor<*xf64>

    %v62_tdyn = kernel.launch @cutensornetContraction2_f64(%extracted_slice_12_contract_62_tc0, %v61_contract_62_tc1, %extracted_slice_11_contract_62_tc2) {contraction_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d3, d1)>, affine_map<(d0, d1, d2, d3) -> (d0, d2, d1, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d2, d1)>]} : (tensor<*xf64>, tensor<*xf64>, tensor<*xf64>) -> tensor<*xf64>

    %62 = tensor.cast %v62_tdyn : tensor<*xf64> to tensor<?x?x?xf64>
