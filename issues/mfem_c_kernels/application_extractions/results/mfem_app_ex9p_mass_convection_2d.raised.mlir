...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @mfem_app_ex9p_mass_convection_2d(%arg0: memref<?xf64>, %arg1: memref<?xf64>, %arg2: memref<?xf64>, %arg3: memref<?xf64>, %arg4: memref<?xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>, %arg7: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    ^bb0(%in: f64, %in_8: f64, %out: f64):
      %18 = arith.mulf %in, %in_8 : f64
      %19 = arith.addf %out, %18 : f64
      linalg.yield %19 : f64
    }
    linalg.generic {indexing_maps = [#map], iterator_types = ["parallel", "parallel", "parallel"]} outs(%alloca_0 : memref<2x5x5xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    }
    %2 = polygeist.submap(%arg0, %c2, %c5, %c5, %c4) {map = #map5} : (memref<?xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    linalg.generic {indexing_maps = [#map3, #map6, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"]} ins(%2, %alloca_1 : memref<?x?x?x?xf64>, memref<2x4x5xf64>) outs(%alloca_0 : memref<2x5x5xf64>) {
    ^bb0(%in: f64, %in_8: f64, %out: f64):
      %18 = arith.mulf %in, %in_8 : f64
      %19 = arith.addf %out, %18 : f64
      linalg.yield %19 : f64
    ...
    linalg.generic {indexing_maps = [#map, #map], iterator_types = ["parallel", "parallel", "parallel"]} ins(%3 : memref<?x?x?xf64>) outs(%alloca_0 : memref<2x5x5xf64>) {
    ^bb0(%in: f64, %out: f64):
      %18 = arith.mulf %out, %in : f64
      linalg.yield %18 : f64
    }
    linalg.generic {indexing_maps = [#map], iterator_types = ["parallel", "parallel", "parallel"]} outs(%alloca : memref<2x5x4xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    }
    %4 = polygeist.submap(%arg2, %c2, %c5, %c4, %c5) {map = #map8} : (memref<?xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    linalg.generic {indexing_maps = [#map3, #map9, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"]} ins(%4, %alloca_0 : memref<?x?x?x?xf64>, memref<2x5x5xf64>) outs(%alloca : memref<2x5x4xf64>) {
    ^bb0(%in: f64, %in_8: f64, %out: f64):
      %18 = arith.mulf %in, %in_8 : f64
      %19 = arith.addf %out, %18 : f64
      linalg.yield %19 : f64
    ...
    %6 = polygeist.submap(%arg6, %c2, %c4, %c4, %c5) {map = #map11} : (memref<?xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    linalg.generic {indexing_maps = [#map3, #map6, #map3], iterator_types = ["parallel", "parallel", "parallel", "reduction"]} ins(%5, %alloca : memref<?x?x?x?xf64>, memref<2x5x4xf64>) outs(%6 : memref<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_8: f64, %out: f64):
      %18 = arith.mulf %in, %in_8 : f64
      %19 = arith.addf %out, %18 : f64
      linalg.yield %19 : f64
    ...
    linalg.generic {indexing_maps = [#map], iterator_types = ["parallel", "parallel", "parallel"]} outs(%alloca_7 : memref<2x4x5xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    }
    ...
    linalg.generic {indexing_maps = [#map3, #map3, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"]} ins(%7, %8 : memref<?x?x?x?xf64>, memref<?x?x?x?xf64>) outs(%alloca_7 : memref<2x4x5xf64>) {
    ^bb0(%in: f64, %in_8: f64, %out: f64):
      %18 = arith.mulf %in, %in_8 : f64
      %19 = arith.addf %out, %18 : f64
      linalg.yield %19 : f64
    ...
    linalg.generic {indexing_maps = [#map3, #map3, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"]} ins(%9, %10 : memref<?x?x?x?xf64>, memref<?x?x?x?xf64>) outs(%alloca_6 : memref<2x4x5xf64>) {
    ^bb0(%in: f64, %in_8: f64, %out: f64):
      %18 = arith.mulf %in, %in_8 : f64
      %19 = arith.addf %out, %18 : f64
      linalg.yield %19 : f64
    }
    linalg.generic {indexing_maps = [#map], iterator_types = ["parallel", "parallel", "parallel"]} outs(%alloca_5 : memref<2x5x5xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    }
    %11 = polygeist.submap(%arg0, %c2, %c5, %c5, %c4) {map = #map5} : (memref<?xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    linalg.generic {indexing_maps = [#map6, #map3, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"]} ins(%alloca_6, %11 : memref<2x4x5xf64>, memref<?x?x?x?xf64>) outs(%alloca_5 : memref<2x5x5xf64>) {
    ^bb0(%in: f64, %in_8: f64, %out: f64):
      %18 = arith.mulf %in, %in_8 : f64
      %19 = arith.addf %out, %18 : f64
      linalg.yield %19 : f64
    ...
    linalg.generic {indexing_maps = [#map6, #map3, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"]} ins(%alloca_7, %12 : memref<2x4x5xf64>, memref<?x?x?x?xf64>) outs(%alloca_4 : memref<2x5x5xf64>) {
    ^bb0(%in: f64, %in_8: f64, %out: f64):
      %18 = arith.mulf %in, %in_8 : f64
      %19 = arith.addf %out, %18 : f64
      linalg.yield %19 : f64
    }
    linalg.generic {indexing_maps = [#map], iterator_types = ["parallel", "parallel", "parallel"]} outs(%alloca_3 : memref<2x5x4xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    }
    ...
    linalg.generic {indexing_maps = [#map3, #map9, #map3, #map9, #map3, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"]} ins(%13, %alloca_5, %14, %alloca_4, %15 : memref<?x?x?x?xf64>, memref<2x5x5xf64>, memref<?x?x?x?xf64>, memref<2x5x5xf64>, memref<?x?x?x?xf64>) outs(%alloca_3 : memref<2x5x4xf64>) {
    ^bb0(%in: f64, %in_8: f64, %in_9: f64, %in_10: f64, %in_11: f64, %out: f64):
      %18 = arith.mulf %in, %in_8 : f64
      %19 = arith.mulf %in_9, %in_10 : f64
      %20 = arith.addf %18, %19 : f64
      %21 = arith.mulf %20, %in_11 : f64
      %22 = arith.addf %out, %21 : f64
      linalg.yield %22 : f64
    }
    linalg.generic {indexing_maps = [#map], iterator_types = ["parallel", "parallel", "parallel"]} outs(%alloca_2 : memref<2x4x4xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    }
    %16 = polygeist.submap(%arg2, %c2, %c4, %c4, %c5) {map = #map10} : (memref<?xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    linalg.generic {indexing_maps = [#map6, #map3, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"]} ins(%alloca_3, %16 : memref<2x5x4xf64>, memref<?x?x?x?xf64>) outs(%alloca_2 : memref<2x4x4xf64>) {
    ^bb0(%in: f64, %in_8: f64, %out: f64):
      %18 = arith.mulf %in, %in_8 : f64
      %19 = arith.addf %out, %18 : f64
      linalg.yield %19 : f64
    }
    %17 = polygeist.submap(%arg7, %c2, %c4, %c4) {map = #map14} : (memref<?xf64>, index, index, index) -> memref<?x?x?xf64>
    linalg.generic {indexing_maps = [#map, #map], iterator_types = ["parallel", "parallel", "parallel"]} ins(%alloca_2 : memref<2x4x4xf64>) outs(%17 : memref<?x?x?xf64>) {
    ^bb0(%in: f64, %out: f64):
