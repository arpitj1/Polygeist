...
#map8 = affine_map<(d0, d1, d2, d3) -> (d3 + d0 * 50 + d1 * 5)>
...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @mfem_pa_convection_apply_2d_stage_sliced(%arg0: memref<?xf64>, %arg1: memref<?xf64>, %arg2: memref<?xf64>, %arg3: memref<?xf64>, %arg4: memref<?xf64>, %arg5: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %27 = polygeist.submap(%3, %c2, %c5, %c4, %c5) {map = #map7} : (tensor<?xf64>, index, index, index, index) -> tensor<?x?x?x?xf64>
    %28 = polygeist.submap(%2, %c2, %c5, %c4, %c5) {map = #map8} : (tensor<?xf64>, index, index, index, index) -> tensor<?x?x?x?xf64>
    %29 = polygeist.submap(%2, %c2, %c5, %c4, %c5) {map = #map9} : (tensor<?xf64>, index, index, index, index) -> tensor<?x?x?x?xf64>
    %30 = linalg.generic {doc = "", indexing_maps = [#map3, #map10, #map3, #map10, #map3, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%28, %22, %29, %25, %27 : tensor<?x?x?x?xf64>, tensor<2x5x5xf64>, tensor<?x?x?x?xf64>, tensor<2x5x5xf64>, tensor<?x?x?x?xf64>) outs(%26 : tensor<2x5x4xf64>) {
    ^bb0(%in: f64, %in_0: f64, %in_1: f64, %in_2: f64, %in_3: f64, %out: f64):
      %38 = arith.mulf %in, %in_0 : f64
      %39 = arith.mulf %in_1, %in_2 : f64
      %40 = arith.addf %38, %39 : f64
      %41 = arith.mulf %40, %in_3 : f64
    ...
    %35 = linalg.generic {doc = "", indexing_maps = [#map, #map], iterator_types = ["parallel", "parallel", "parallel"], library_call = ""} ins(%33 : tensor<2x4x4xf64>) outs(%34 : tensor<?x?x?xf64>) {
    ^bb0(%in: f64, %out: f64):
      %38 = arith.addf %out, %in : f64
      linalg.yield %38 : f64
    } -> tensor<?x?x?xf64>
    %36 = polygeist.submapInverse(%0, %35, %c2, %c4, %c4) {map = #map12} : (tensor<?xf64>, tensor<?x?x?xf64>, index, index, index) -> tensor<?xf64>
    %37 = bufferization.to_memref %36 : memref<?xf64>
    memref.copy %37, %arg5 : memref<?xf64> to memref<?xf64>
    return
  }
}
