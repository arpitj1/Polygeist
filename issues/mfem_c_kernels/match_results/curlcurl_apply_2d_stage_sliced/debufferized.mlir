...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @mfem_pa_curlcurl_apply_2d_stage_sliced(%arg0: memref<?xf64>, %arg1: memref<?xf64>, %arg2: memref<?xf64>, %arg3: memref<?xf64>, %arg4: memref<?xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %21 = linalg.generic {doc = "", indexing_maps = [#map6, #map3, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%18, %20 : tensor<2x4x5xf64>, tensor<?x?x?x?xf64>) outs(%19 : tensor<2x5x5xf64>) {
    ^bb0(%in: f64, %in_0: f64, %out: f64):
      %50 = arith.mulf %in, %in_0 : f64
      %51 = arith.addf %out, %50 : f64
      linalg.yield %51 : f64
    } -> tensor<2x5x5xf64>
    %22 = linalg.generic {doc = "", indexing_maps = [#map], iterator_types = ["parallel", "parallel", "parallel"], library_call = ""} outs(%13 : tensor<2x3x5xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<2x3x5xf64>
    ...
    %25 = linalg.generic {doc = "", indexing_maps = [#map3, #map3, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%24, %23 : tensor<?x?x?x?xf64>, tensor<?x?x?x?xf64>) outs(%22 : tensor<2x3x5xf64>) {
    ^bb0(%in: f64, %in_0: f64, %out: f64):
      %50 = arith.mulf %in, %in_0 : f64
      %51 = arith.addf %out, %50 : f64
      linalg.yield %51 : f64
    ...
    %28 = linalg.generic {doc = "", indexing_maps = [#map6, #map3, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%25, %27 : tensor<2x3x5xf64>, tensor<?x?x?x?xf64>) outs(%26 : tensor<2x5x5xf64>) {
    ^bb0(%in: f64, %in_0: f64, %out: f64):
      %50 = arith.mulf %in, %in_0 : f64
      %51 = arith.addf %out, %50 : f64
      linalg.yield %51 : f64
    ...
    %40 = linalg.generic {doc = "", indexing_maps = [#map], iterator_types = ["parallel", "parallel", "parallel"], library_call = ""} outs(%7 : tensor<2x3x4xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    } -> tensor<2x3x4xf64>
    %41 = polygeist.submap(%5, %c2, %c3, %c4, %c5) {map = #map13} : (tensor<?xf64>, index, index, index, index) -> tensor<?x?x?x?xf64>
    %42 = linalg.generic {doc = "", indexing_maps = [#map6, #map3, #map4], iterator_types = ["parallel", "parallel", "parallel", "reduction"], library_call = ""} ins(%39, %41 : tensor<2x5x4xf64>, tensor<?x?x?x?xf64>) outs(%40 : tensor<2x3x4xf64>) {
    ^bb0(%in: f64, %in_0: f64, %out: f64):
      %50 = arith.mulf %in, %in_0 : f64
      %51 = arith.addf %out, %50 : f64
      linalg.yield %51 : f64
    ...
    %44 = linalg.generic {doc = "", indexing_maps = [#map, #map], iterator_types = ["parallel", "parallel", "parallel"], library_call = ""} ins(%35 : tensor<2x4x3xf64>) outs(%43 : tensor<?x?x?xf64>) {
    ^bb0(%in: f64, %out: f64):
    ...
    %47 = linalg.generic {doc = "", indexing_maps = [#map, #map], iterator_types = ["parallel", "parallel", "parallel"], library_call = ""} ins(%42 : tensor<2x3x4xf64>) outs(%46 : tensor<?x?x?xf64>) {
    ^bb0(%in: f64, %out: f64):
      %50 = arith.addf %out, %in : f64
      linalg.yield %50 : f64
    } -> tensor<?x?x?xf64>
