...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @mfem_pa_divdiv_apply_2d_stage_sliced(%arg0: memref<?xf64>, %arg1: memref<?xf64>, %arg2: memref<?xf64>, %arg3: memref<?xf64>, %arg4: memref<?xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %v14_contract_18_tc2 = tensor.cast %14 : tensor<2x3x5xf64> to tensor<*xf64>
    ...
    %18 = tensor.cast %v18_tdyn : tensor<*xf64> to tensor<2x3x5xf64>
    %20 = polygeist.submap(%6, %c2, %c5, %c5, %c3) {map = #map5} : (tensor<?xf64>, index, index, index, index) -> tensor<?x?x?x?xf64>
    %v18_contract_21_tc0 = tensor.cast %18 : tensor<2x3x5xf64> to tensor<*xf64>
    ...
    %v13_contract_25_tc2 = tensor.cast %13 : tensor<2x4x5xf64> to tensor<*xf64>
    ...
    %25 = tensor.cast %v25_tdyn : tensor<*xf64> to tensor<2x4x5xf64>
    %27 = polygeist.submap(%4, %c2, %c5, %c5, %c4) {map = #map9} : (tensor<?xf64>, index, index, index, index) -> tensor<?x?x?x?xf64>
    %v25_contract_28_tc0 = tensor.cast %25 : tensor<2x4x5xf64> to tensor<*xf64>
    ...
    %v32_contract_35_tc0 = tensor.cast %32 : tensor<2x5x4xf64> to tensor<*xf64>

    %v34_contract_35_tc1 = tensor.cast %34 : tensor<?x?x?x?xf64> to tensor<*xf64>

    %v8_contract_35_tc2 = tensor.cast %8 : tensor<2x3x4xf64> to tensor<*xf64>

    %v35_tdyn = kernel.launch @cutensornetContraction2_f64(%v32_contract_35_tc0, %v34_contract_35_tc1, %v8_contract_35_tc2) {contraction_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d3, d1)>, affine_map<(d0, d1, d2, d3) -> (d0, d2, d1, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d2, d1)>]} : (tensor<*xf64>, tensor<*xf64>, tensor<*xf64>) -> tensor<*xf64>

    %35 = tensor.cast %v35_tdyn : tensor<*xf64> to tensor<2x3x4xf64>
    ...
    %v39_contract_42_tc0 = tensor.cast %39 : tensor<2x5x3xf64> to tensor<*xf64>

    %v41_contract_42_tc1 = tensor.cast %41 : tensor<?x?x?x?xf64> to tensor<*xf64>

    %v7_contract_42_tc2 = tensor.cast %7 : tensor<2x4x3xf64> to tensor<*xf64>
    ...
    %42 = tensor.cast %v42_tdyn : tensor<*xf64> to tensor<2x4x3xf64>
