...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @mfem_interp_grad_3d_stage_sliced(%arg0: memref<?xf64>, %arg1: memref<?xf64>, %arg2: memref<?xf64>, %arg3: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %v8_tc2 = tensor.cast %8 : tensor<2x4x4x5xf64> to tensor<?x?x?x?xf64>

    %v12_tdyn = kernel.launch @cublasGemmFor1x1Conv(%10, %11, %v8_tc2) : (tensor<?x?x?x?x?xf64>, tensor<?x?x?x?x?xf64>, tensor<?x?x?x?xf64>) -> tensor<?x?x?x?xf64>
    ...
    %v7_tc2 = tensor.cast %7 : tensor<2x4x4x5xf64> to tensor<?x?x?x?xf64>

    %v16_tdyn = kernel.launch @cublasGemmFor1x1Conv(%14, %15, %v7_tc2) : (tensor<?x?x?x?x?xf64>, tensor<?x?x?x?x?xf64>, tensor<?x?x?x?xf64>) -> tensor<?x?x?x?xf64>
    ...
    %v16_tc1 = tensor.cast %16 : tensor<2x4x4x5xf64> to tensor<?x?x?x?xf64>

    %v6_tc2 = tensor.cast %6 : tensor<2x4x5x5xf64> to tensor<?x?x?x?xf64>

    %v19_tdyn = kernel.launch @cublasGemmFor1x1Conv(%18, %v16_tc1, %v6_tc2) : (tensor<?x?x?x?x?xf64>, tensor<?x?x?x?xf64>, tensor<?x?x?x?xf64>) -> tensor<?x?x?x?xf64>
    ...
    %v12_tc1 = tensor.cast %12 : tensor<2x4x4x5xf64> to tensor<?x?x?x?xf64>

    %v5_tc2 = tensor.cast %5 : tensor<2x4x5x5xf64> to tensor<?x?x?x?xf64>

    %v22_tdyn = kernel.launch @cublasGemmFor1x1Conv(%21, %v12_tc1, %v5_tc2) : (tensor<?x?x?x?x?xf64>, tensor<?x?x?x?xf64>, tensor<?x?x?x?xf64>) -> tensor<?x?x?x?xf64>
    ...
    %v4_tc2 = tensor.cast %4 : tensor<2x4x5x5xf64> to tensor<?x?x?x?xf64>

    %v25_tdyn = kernel.launch @cublasGemmFor1x1Conv(%24, %v12_tc1, %v4_tc2) : (tensor<?x?x?x?x?xf64>, tensor<?x?x?x?xf64>, tensor<?x?x?x?xf64>) -> tensor<?x?x?x?xf64>
    ...
    %v19_tc1 = tensor.cast %19 : tensor<2x4x5x5xf64> to tensor<?x?x?x?xf64>

    %31 = kernel.launch @cublasGemmFor1x1Conv(%29, %v19_tc1, %26) : (tensor<?x?x?x?x?xf64>, tensor<?x?x?x?xf64>, tensor<?x?x?x?xf64>) -> tensor<?x?x?x?x?xf64>
    ...
    %v22_tc1 = tensor.cast %22 : tensor<2x4x5x5xf64> to tensor<?x?x?x?xf64>

    %38 = kernel.launch @cublasGemmFor1x1Conv(%36, %v22_tc1, %33) : (tensor<?x?x?x?x?xf64>, tensor<?x?x?x?xf64>, tensor<?x?x?x?xf64>) -> tensor<?x?x?x?x?xf64>
    ...
    %v25_tc1 = tensor.cast %25 : tensor<2x4x5x5xf64> to tensor<?x?x?x?xf64>

    %45 = kernel.launch @cublasGemmFor1x1Conv(%43, %v25_tc1, %40) : (tensor<?x?x?x?x?xf64>, tensor<?x?x?x?xf64>, tensor<?x?x?x?xf64>) -> tensor<?x?x?x?x?xf64>
