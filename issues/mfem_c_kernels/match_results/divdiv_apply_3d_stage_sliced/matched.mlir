...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @mfem_pa_divdiv_apply_3d_stage_sliced(%arg0: memref<?xf64>, %arg1: memref<?xf64>, %arg2: memref<?xf64>, %arg3: memref<?xf64>, %arg4: memref<?xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %v21_tc2 = tensor.cast %21 : tensor<2x4x4x5xf64> to tensor<?x?x?x?xf64>

    %v25_tdyn = kernel.launch @cublasGemmFor1x1Conv(%24, %23, %v21_tc2) : (tensor<?x?x?x?x?xf64>, tensor<?x?x?x?x?xf64>, tensor<?x?x?x?xf64>) -> tensor<?x?x?x?xf64>
    ...
    %v25_tc1 = tensor.cast %25 : tensor<2x4x4x5xf64> to tensor<?x?x?x?xf64>

    %v18_tc2 = tensor.cast %18 : tensor<2x4x5x5xf64> to tensor<?x?x?x?xf64>

    %v28_tdyn = kernel.launch @cublasGemmFor1x1Conv(%27, %v25_tc1, %v18_tc2) : (tensor<?x?x?x?x?xf64>, tensor<?x?x?x?xf64>, tensor<?x?x?x?xf64>) -> tensor<?x?x?x?xf64>
    ...
    %v28_tc1 = tensor.cast %28 : tensor<2x4x5x5xf64> to tensor<?x?x?x?xf64>

    %v15_tc2 = tensor.cast %15 : tensor<2x5x5x5xf64> to tensor<?x?x?x?xf64>

    %v31_tdyn = kernel.launch @cublasGemmFor1x1Conv(%30, %v28_tc1, %v15_tc2) : (tensor<?x?x?x?x?xf64>, tensor<?x?x?x?xf64>, tensor<?x?x?x?xf64>) -> tensor<?x?x?x?xf64>
    ...
    %v20_tc2 = tensor.cast %20 : tensor<2x4x4x5xf64> to tensor<?x?x?x?xf64>

    %v35_tdyn = kernel.launch @cublasGemmFor1x1Conv(%34, %33, %v20_tc2) : (tensor<?x?x?x?x?xf64>, tensor<?x?x?x?x?xf64>, tensor<?x?x?x?xf64>) -> tensor<?x?x?x?xf64>
    ...
    %v35_tc1 = tensor.cast %35 : tensor<2x4x4x5xf64> to tensor<?x?x?x?xf64>

    %v17_tc2 = tensor.cast %17 : tensor<2x4x5x5xf64> to tensor<?x?x?x?xf64>

    %v38_tdyn = kernel.launch @cublasGemmFor1x1Conv(%37, %v35_tc1, %v17_tc2) : (tensor<?x?x?x?x?xf64>, tensor<?x?x?x?xf64>, tensor<?x?x?x?xf64>) -> tensor<?x?x?x?xf64>
    ...
    %v38_tc1 = tensor.cast %38 : tensor<2x4x5x5xf64> to tensor<?x?x?x?xf64>

    %v14_tc2 = tensor.cast %14 : tensor<2x5x5x5xf64> to tensor<?x?x?x?xf64>

    %v41_tdyn = kernel.launch @cublasGemmFor1x1Conv(%40, %v38_tc1, %v14_tc2) : (tensor<?x?x?x?x?xf64>, tensor<?x?x?x?xf64>, tensor<?x?x?x?xf64>) -> tensor<?x?x?x?xf64>
    ...
    %v19_tc2 = tensor.cast %19 : tensor<2x4x4x5xf64> to tensor<?x?x?x?xf64>

    %v45_tdyn = kernel.launch @cublasGemmFor1x1Conv(%44, %43, %v19_tc2) : (tensor<?x?x?x?x?xf64>, tensor<?x?x?x?x?xf64>, tensor<?x?x?x?xf64>) -> tensor<?x?x?x?xf64>
    ...
    %v45_tc1 = tensor.cast %45 : tensor<2x4x4x5xf64> to tensor<?x?x?x?xf64>

    %v16_tc2 = tensor.cast %16 : tensor<2x4x5x5xf64> to tensor<?x?x?x?xf64>

    %v48_tdyn = kernel.launch @cublasGemmFor1x1Conv(%47, %v45_tc1, %v16_tc2) : (tensor<?x?x?x?x?xf64>, tensor<?x?x?x?xf64>, tensor<?x?x?x?xf64>) -> tensor<?x?x?x?xf64>
    ...
    %v48_tc1 = tensor.cast %48 : tensor<2x4x5x5xf64> to tensor<?x?x?x?xf64>

    %v13_tc2 = tensor.cast %13 : tensor<2x5x5x5xf64> to tensor<?x?x?x?xf64>

    %v51_tdyn = kernel.launch @cublasGemmFor1x1Conv(%50, %v48_tc1, %v13_tc2) : (tensor<?x?x?x?x?xf64>, tensor<?x?x?x?xf64>, tensor<?x?x?x?xf64>) -> tensor<?x?x?x?xf64>
    ...
    %v66_tdyn = kernel.launch @cublasGemmFor1x1Conv(%65, %v55_tc1, %v9_tc2) : (tensor<?x?x?x?x?xf64>, tensor<?x?x?x?xf64>, tensor<?x?x?x?xf64>) -> tensor<?x?x?x?xf64>
    ...
    %v59_tc1 = tensor.cast %59 : tensor<2x5x5x4xf64> to tensor<?x?x?x?xf64>

    %v8_tc2 = tensor.cast %8 : tensor<2x5x4x4xf64> to tensor<?x?x?x?xf64>

    %v69_tdyn = kernel.launch @cublasGemmFor1x1Conv(%68, %v59_tc1, %v8_tc2) : (tensor<?x?x?x?x?xf64>, tensor<?x?x?x?xf64>, tensor<?x?x?x?xf64>) -> tensor<?x?x?x?xf64>
    ...
    %v63_tc1 = tensor.cast %63 : tensor<2x5x5x4xf64> to tensor<?x?x?x?xf64>

    %v7_tc2 = tensor.cast %7 : tensor<2x5x4x4xf64> to tensor<?x?x?x?xf64>

    %v72_tdyn = kernel.launch @cublasGemmFor1x1Conv(%71, %v63_tc1, %v7_tc2) : (tensor<?x?x?x?x?xf64>, tensor<?x?x?x?xf64>, tensor<?x?x?x?xf64>) -> tensor<?x?x?x?xf64>
